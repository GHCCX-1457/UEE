...
.left{
  ...
  width: 67px;
  height: 139px;
  background-image: url("@/assets/hz-decoration/1/left.png");
...
.center{
  ...
  height: 139px;
  background-image: url("@/assets/hz-decoration/1/content.png");
  background-size: 100% 100%;
}
...
.right{
  ...
  width: 67px;
  height: 139px;
  background-image: url("@/assets/hz-decoration/1/right.png");
  background-size: 100% 100%;
  background-repeat: no-repeat;
}
