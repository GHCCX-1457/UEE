...
import {add, del, list, update} from "@/api/gaokao/Xunlianshuju-API";
import {_itemInfo, columnsOption, itemInfo, pagination} from "@/const/crud/gaokao/Xunlianshuju-CRUD";
